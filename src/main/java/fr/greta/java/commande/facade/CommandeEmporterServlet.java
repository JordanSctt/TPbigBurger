...
@WebServlet("/actionCommanderUserEmporter")
public class CommandeEmporterServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        commande.setTypeLivraison(CommandeTypeLivraison.EMPORTER);
        try {
