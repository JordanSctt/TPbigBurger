...
<center><p><h1>Nombre de menu : <c:out value = "${commande.menu}"/></h1></p></center>
<center><p><h1>Reduction : <c:out value = "${commande.reductionMenu}"/> euros</h1></p></center>
<center><p><h1>Prix Final : <c:out value = "${commande.prixTotal - commande.reductionMenu}"/> euros</h1></p></center>
