...
<html lang="en">
  <head>
    ...
    <title>Page de connection livreur(s)</title>
...
<link rel="stylesheet" href="css/bootstrap.min.css">
  ...
  <!-- FORMULAIRE : -->
    ...
    <form class="form-signin" action="connectionLivreur" method="POST">
  <div class="text-center mb-4">

    <h1 class="h3 mb-3 font-weight-normal">Se connecter en tant que livreur</h1>
